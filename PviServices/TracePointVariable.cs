...
// Type: BR.AN.PviServices.TracePointVariable
...
namespace BR.AN.PviServices
{
  public class TracePointVariable : IDisposable
  {
    ...
    {
      this.propDataType = (IECDataTypes) dataType;
      this.propData = (byte[]) null;
    ...
    public override string ToString()
    {
      ...
      return "Name=\"" + this.propName + "\" Type=\"" + this.propDataType.ToString() + "\" DataLength=\"" + (this.propData != null ? this.propData.GetLength(0).ToString() : "0") + "\"\" Data=\"" + str + "\"";
    }
